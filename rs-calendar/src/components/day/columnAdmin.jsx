...
import { tempEventGet, tempEventSet, eventBackupGet, speakersTempGet } from '../../instruments/eventsBackup';
...
export default class Column extends React.Component {
  ...
  _closeDiscard = () => {
    ...
    let [appliedEventsMonth, avalDays, backupDayEvents] = this.props.day._applyEventsOnDates(filtered, this.props.day.state.day.date); // eslint-disable-line
